...
public class Skill_force_avarice : SkillBase
{
	public Skill_force_avarice(SkillParameter skillPrm, string option)
	...
	public override VfxWithLoading Start(CallParameter parameter)
	{
		...
		{
			VfxBase vfx = targetCard.SkillApplyInformation.GiveForceAvarice(parameter.skillProcessor);
	...
	public override VfxWithLoading Stop(SkillProcessor skillProcessor)
	{
		...
		{
			VfxBase vfx = item._targetCard.SkillApplyInformation.DepriveForceAvarice();
			parallelVfxPlayer.Register(vfx);
	...
	public override void SetOnLoseEvent(BattleCardBase targetCard, BuffInfo buff, BuffInfoContainer container)
	{
		targetCard.OnLoseSkillOneTime += delegate(SkillBase loseSkill, SkillProcessor skillProcessor, BattleCardBase card)
		{
			...
			return card.SkillApplyInformation.ForceDepriveForceAvarice();
		};
	}
}
