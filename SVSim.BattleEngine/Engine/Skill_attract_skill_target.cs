...
public class Skill_attract_skill_target : SkillBase
{
	public Skill_attract_skill_target(SkillParameter skillPrm, string option)
	...
	public override VfxWithLoading Start(CallParameter parameter)
	{
		...
		{
			VfxBase vfx = targetCard.SkillApplyInformation.GiveAttractSkillTarget();
		...
		{
			BattleLogManager.GetInstance().AddLogSkillGain(parameter.targetCards.ToList(), this, SkillGainType.AttractSkillTarget);
		}
	...
	public override VfxWithLoading Stop(SkillProcessor skillProcessor)
	{
		...
		{
			VfxBase vfx = item._targetCard.SkillApplyInformation.DepriveAttractSkillTarget();
	...
	public override void SetOnLoseEvent(BattleCardBase targetCard, BuffInfo buff, BuffInfoContainer container)
	{
		targetCard.OnLoseSkillOneTime += delegate(SkillBase loseSkill, SkillProcessor skillProcessor, BattleCardBase card)
		{
			...
			return card.SkillApplyInformation.ForceDepriveAttractSkillTarget();
		};
	}
}
