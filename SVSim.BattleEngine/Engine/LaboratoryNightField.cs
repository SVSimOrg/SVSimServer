...
public class LaboratoryNightField : LaboratoryField
{
	public override int FieldId => 17;
	public override int FieldEffectId => 7;

	public LaboratoryNightField(string bgmId = "NONE")
		: base(bgmId)
	{
	}
}
