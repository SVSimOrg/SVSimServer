...
public class Skill_ignore_guard : SkillBase
{
	public Skill_ignore_guard(SkillParameter skillPrm, string option)
	...
	public override VfxWithLoading Start(CallParameter parameter)
	{
		...
		{
			VfxBase vfx = targetCard.SkillApplyInformation.GiveIgnoreGuard();
		...
		{
			BattleLogManager.GetInstance().AddLogSkillGain(parameter.targetCards.ToList(), this, SkillGainType.IgnoreGuard);
		}
	...
	public override VfxWithLoading Stop(SkillProcessor skillProcessor)
	{
		...
		{
			VfxBase vfx = item._targetCard.SkillApplyInformation.DepriveIgnoreGuard();
	...
	public override void SetOnLoseEvent(BattleCardBase targetCard, BuffInfo buff, BuffInfoContainer container)
	{
		targetCard.OnLoseSkillOneTime += delegate(SkillBase loseSkill, SkillProcessor skillProcessor, BattleCardBase card)
		{
			...
			return card.SkillApplyInformation.FourceDepriveIgnoreGuard();
		};
	}
}
