...
public class Skill_indestructible : SkillBase
{
	public Skill_indestructible(SkillParameter skillPrm, string option)
	...
	public override VfxWithLoading Start(CallParameter parameter)
	{
		...
		{
			VfxBase vfx = targetCard.SkillApplyInformation.GiveIndestructible();
		...
		{
			BattleLogManager.GetInstance().AddLogSkillGain(parameter.targetCards.ToList(), this, SkillGainType.Indestructible);
		}
	...
	public override VfxWithLoading Stop(SkillProcessor skillProcessor)
	{
		...
		{
			VfxBase vfx = item._targetCard.SkillApplyInformation.DepriveIndestructible();
	...
	public override void SetOnLoseEvent(BattleCardBase targetCard, BuffInfo buff, BuffInfoContainer container)
	{
		targetCard.OnLoseSkillOneTime += delegate(SkillBase loseSkill, SkillProcessor skillProcessor, BattleCardBase card)
		{
			...
			return card.SkillApplyInformation.ForceDepriveIndestructible();
		};
	}
}
