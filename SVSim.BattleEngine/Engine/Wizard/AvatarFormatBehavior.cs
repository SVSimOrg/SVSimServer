...
public class AvatarFormatBehavior : IFormatBehavior
{
	public string Name => Data.SystemText.Get("HeroesBattle_0001");

	public string SmallIconSpriteName => "icon_heroesbattle_s";
