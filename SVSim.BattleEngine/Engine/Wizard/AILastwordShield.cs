...
public class AILastwordShield : AIFiltersAndSelectTypeArgument
{
	...
	public AILastwordShield(string text)
		: base(text)
	{
	}
	...
	public override void Execute(AIVirtualCard tagOwner, AIVirtualField field, List<int> playPtn, AISituationInfo situation = null)
	{
		...
		{
			AIBarrierSimulationUtility.AddShieldToAll(targetsFromField, tagOwner, field, _damageType, _stopTiming);
		}
	}
}
