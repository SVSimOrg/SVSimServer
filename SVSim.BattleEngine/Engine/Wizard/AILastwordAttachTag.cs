...
public class AILastwordAttachTag : AIFiltersArgument
{
	...
	public AILastwordAttachTag(string text)
		: base(text)
	{
	}
	...
	public override void Execute(AIVirtualCard tagOwner, AIVirtualField field, List<int> playPtn, AISituationInfo situation = null)
	{
		...
		if (targetsFromField != null && targetsFromField.Count > 0)
		{
			...
			case AIScriptTokenArgType.RANDOM_SELECT:
			{
				...
				AIAttachTagSimulationUtility.SimulateRandomSelectAttachTag(targetsFromField, 1, tagOwner, field, playPtn, situation, Tag, RemoveTiming, selectLogic);
				break;
			}
			}
		}
