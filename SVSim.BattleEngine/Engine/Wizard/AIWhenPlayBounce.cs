...
public class AIWhenPlayBounce : AIWhenPlayTagArgument
{
	protected override bool _isSelectCountImplemented => true;

	public AIWhenPlayBounce(string text)
		: base(text)
	{
	}
	...
	public override void Execute(AIVirtualCard tagOwner, AIVirtualField field, List<int> playPtn, AISituationInfo situation = null)
	{
		...
		if (targetsFromField != null && targetsFromField.Count > 0)
		{
			...
			case AIScriptTokenArgType.RANDOM_SELECT:
			{
				...
				AIBounceSimulationUtility.BounceRandom(targetsFromField, tagOwner, field, playPtn, situation, selectCount);
				break;
			}
			case AIScriptTokenArgType.TARGET_SELECT:
			case AIScriptTokenArgType.SECOND_TARGET_SELECT:
				AIBounceSimulationUtility.ExecuteTargetSelectBounce(tagOwner, targetsFromField, situation, field, playPtn, base.SelectType, GetRemovalType(), GetSelectCount(tagOwner, field, playPtn, situation));
				break;
