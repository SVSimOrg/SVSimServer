...
public class Skill_killer : SkillBase
{
	public Skill_killer(SkillParameter skillPrm, string option)
	...
	public override VfxWithLoading Start(CallParameter parameter)
	{
		...
		{
			VfxBase vfx = targetCard.SkillApplyInformation.GiveKiller();
		...
		{
			BattleLogManager.GetInstance().AddLogSkillGain(parameter.targetCards.ToList(), this, SkillGainType.Killer);
		}
	...
	public override VfxWithLoading Stop(SkillProcessor skillProcessor)
	{
		...
		{
			VfxBase vfx = item._targetCard.SkillApplyInformation.DepriveKiller();
	...
	public override void SetOnLoseEvent(BattleCardBase targetCard, BuffInfo buff, BuffInfoContainer container)
	{
		targetCard.OnLoseSkillOneTime += delegate(SkillBase loseSkill, SkillProcessor skillProcessor, BattleCardBase card)
		{
			...
			return card.SkillApplyInformation.FourceDepriveKiller();
		};
	}
}
